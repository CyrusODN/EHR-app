...
const LogoSvg: React.FC<LogoSvgProps> = ({ size = 'large', color }) => {
    const { isDark } = useThemeColors();
    
    // Use passed color, or default based on theme
    const fillValue = color || (isDark ? '#E4E4E7' : '#0D0D0D');
        ...
        >
            <Defs>
                <LinearGradient id="gradient1" x1="0" y1="0" x2="1" y2="0">
                    <Stop offset="0" stopColor="#3D97C5" />
                    <Stop offset="1" stopColor="#4FD7C7" />
                </LinearGradient>
