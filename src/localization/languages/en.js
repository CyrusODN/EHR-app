export const en = {
    ...
    visit: {
        ...
        summary: {
            ...
            monitoringScales: 'Monitoring Scales',
            noRecommendations: 'No psychiatric recommendations recorded',
            noRecommendationsHelper: 'Tap "Add Recommendations" to create a treatment plan',
            duration: 'Duration',
            reminders: 'Reminders',
            every: 'Every',
            days: 'days',
            ...
            nextVisitLabels: {
                ...
                creating: 'Creating...',
                created: 'Next Visit Created',
                date: 'Date',
                time: 'Time',
                patient: 'Patient',
                doctor: 'Doctor',
                followUpNotes: 'Follow-up visit for patient',
                successTitle: 'Success',
                successMessage: 'Next visit created successfully!',
                errorTitle: 'Error',
                errorMessage: 'Failed to create next visit. Please try again.',
                cancelConfirmTitle: 'Cancel Visit',
                cancelConfirmMessage: 'Are you sure you want to cancel the next visit?',
                cancelConfirm: 'Yes, Cancel',
                cancelSuccessTitle: 'Cancelled',
                cancelSuccessMessage: 'Next visit has been cancelled.',
                cancelErrorMessage: 'Failed to cancel next visit. Please try again.',
            },
            placeholders: {
        ...
        ai: {
            ...
            tabs: {
                ...
                voice: 'Voice Record',
                diagnostic: 'Diagnostics AI',
                medication: 'Medication AI'
            },
            badge: 'AI Powered',
            cds: {
        ...
        recommendations: {
            ...
            every: 'Every',
            days: 'days',
            instructions_placeholder: 'Dosage instructions (e.g. 1-0-1)',
        ...
        laboratory: {
            title: 'Laboratory',
            tabs: { order: 'New Order', list: 'Orders', results: 'Results' },
            orderForm: {
                title: 'Order Lab Tests',
                searchTests: 'Search available tests...',
                selectedCount: '{{count}} tests selected',
                priority: 'Priority',
                notes: 'Order Notes',
                notesPlaceholder: 'Additional instructions for the lab...',
                submit: 'Place Order',
            },
            priority: { routine: 'Routine', urgent: 'Urgent', stat: 'CITO' },
            status: { ordered: 'Ordered', collected: 'Collected', in_progress: 'In Progress', completed: 'Completed', cancelled: 'Cancelled' },
            orders: { empty: 'No lab orders yet', viewResults: 'View Results' },
            results: {
                title: 'Lab Results',
                verifiedAt: 'Verified',
                criticalWarning: 'Critical values detected!',
                refRange: 'Ref. range',
                interpretation: 'Interpretation',
                attachments: 'Attachments',
                selectOrder: 'Select a completed order to view results',
                flag: { normal: 'Normal', high: 'High', low: 'Low', critical: 'Critical' },
            },
        },
        procedures: {
            title: 'Procedures',
            tabs: { add: 'Add Procedure', list: 'Procedures List' },
            form: {
                ...
                descriptionPlaceholder: 'Describe the procedure...',
                notes: 'Notes',
                notesPlaceholder: 'Additional notes...',
                submit: 'Add Procedure',
            },
            category: { diagnostic: 'Diagnostic', therapeutic: 'Therapeutic', preventive: 'Preventive', surgical: 'Surgical' },
            status: { planned: 'Planned', inProgress: 'In Progress', completed: 'Completed', cancelled: 'Cancelled' },
            list: { empty: 'No procedures scheduled', addResults: 'Add Results' },
            results: {
                title: 'Procedure Results',
                findings: 'Findings',
                findingsPlaceholder: 'Describe the findings...',
                complications: 'Complications',
                complicationsPlaceholder: 'List any complications...',
                recommendations: 'Recommendations',
                recommendationsPlaceholder: 'Post-procedure recommendations...',
        ...
        voiceTranscription: {
            ...
            description: 'Record patient consultation audio for automatic transcription into clinical notes.',
            tapToStart: 'Tap to start recording',
            tapToStop: 'Tap to stop recording',
            uploading: 'Uploading audio...',
            transcribing: 'Transcribing...',
            result: 'Transcription Result',
            applyToInterview: 'Add to Interview',
            permissionDenied: 'Microphone permission denied',
            noVisit: 'No active visit found',
            error: 'An error occurred during transcription',
        },
        diagnosticAssistant: {
            title: 'Diagnostic Assistant',
            welcome: 'Hello! I am your diagnostic assistant. Describe the patient symptoms and I will help with the diagnosis.',
            suggestion: 'Based on the described symptoms, I suggest the following diagnoses:',
            unspecified: 'Illness, unspecified',
            errorResponse: 'Sorry, I could not process your request. Please try again.',
            inputPlaceholder: 'Describe symptoms...',
        },
        medicationAssistant: {
            title: 'Medication Assistant',
            tabs: { graph: 'Knowledge Graph', pharmacy: 'Pharmacy Locator' },
            ...
            nsaids: 'NSAIDs Interaction',
            nodeType: { medication: 'Medication', category: 'Category', indication: 'Indication', interaction: 'Interaction' },
        },
        scaleSummary: {
            title: 'Scale Result Summary',
            aiAnalysis: 'AI Clinical Analysis',
            recommendationsTitle: 'Recommendations',
            addToInterview: 'Add to Interview',
            details: 'Details',
            severity: { none: 'No symptoms', mild: 'Mild symptoms', moderate: 'Moderate symptoms', severe: 'Severe symptoms', verySevere: 'Very severe symptoms' },
            analysis: {
                defaultPoint1: 'Monitor patient symptoms regularly',
                defaultPoint2: 'Consider follow-up assessment in 2-4 weeks',
                defaultPoint3: 'Document changes in clinical presentation',
            },
            recommendations: {
                defaultRec1: 'Continue current treatment plan with regular monitoring',
                defaultRec2: 'Schedule follow-up psychiatric evaluation',
            },
        },
    },
    ai: {
    ...
    personalData: {
        ...
        unnamedAuthPerson: "Unnamed Person",
        authPersonRequiredFields: "First name, last name, and relationship are required.",
        authPersonPhoneRequired: "Phone number is required.",
        authPersonDocumentRequired: "Document type and document number are required.",
        ...
        placeholderPesel: "Enter PESEL",
        placeholderSelectGender: "Select gender",
        placeholderMiddleName: "Enter middle name",
        placeholderMaidenName: "Enter maiden name",
        placeholderBirthPlace: "Enter birth place",
        placeholderBloodType: "A+, O-, etc.",
        placeholderNumber: "No.",
        placeholderCity: "Enter city",
        placeholderStreet: "Enter street",
        placeholderPostalCode: "Enter code",
        placeholderSelectVoivodeship: "Select voivodeship",
        placeholderSelectCountry: "Select country",
        placeholderSelectBranch: "Select branch",
        placeholderSelectRights: "Select rights",
        insuredInNfz: "Insured in NFZ:",
        fileSelectError: "Failed to select file.",
        consentUploadError: "Failed to upload consent document. Please try again.",
        consentPersonalDataTitle: "Processing of Personal Data",
        consentPersonalDataDescription: "I consent to the processing of my personal data for the purpose of providing medical services in accordance with GDPR.",
        consentMedicalDocsTitle: "Access to Medical Documentation",
        consentMedicalDocsDescription: "I consent to providing access to my medical documentation to authorized persons and other medical facilities for the purpose of continuing treatment.",
        consentElectronicCommTitle: "Electronic Communication",
        consentElectronicCommDescription: "I consent to receiving medical and organizational information via electronic means (email, SMS).",
