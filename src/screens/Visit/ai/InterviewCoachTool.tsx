...
const createStyles = (tc: any, isDark: boolean) => StyleSheet.create({
    ...
    tab: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 8, borderRadius: 6, gap: 4 },
    ...
    tabText: { fontSize: 11, color: tc.textMuted },
    tabTextActive: { color: tc.accent, fontWeight: '700' },
    tabBadge: { backgroundColor: tc.accent, borderRadius: 10, paddingHorizontal: 6, paddingVertical: 1, marginLeft: 2 },
